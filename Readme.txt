...
2. **Compile the Program**:
   If you're using GCC, compile the `program.c` file:
   ```bash
...
1. Choose a day of the week by typing the name of the day (e.g., `Monday`).
2. Enter the time you want to watch a show.
3. The program will list all shows available at that time.
4. Type the name of the show you want to add to your schedule.
5. You can choose to go back and add more shows or modify your existing schedule.
6. If the same time is entered again, the program will prompt whether you want to replace or append the current show.
