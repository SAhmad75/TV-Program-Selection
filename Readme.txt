...
Supports a loop, enabling users to go back and add more shows to their weekly schedule.
How It Works
Text Files for Each Day: There are seven text files corresponding to each day of the week. Each file contains the schedule for that day, listing the times and the shows being broadcasted.

User Input: The user selects a day and enters the time they want to watch a show.

Program Search: The program searches the selected day's text file and lists all shows airing at that time.

Save to Schedule: The user types the name of the program they want to add to their weekly schedule.

Modify Schedule: If the user adds a show at a time where a program is already scheduled, the program will ask whether they want to replace the existing program or append the new show to the existing schedule.

Looping: The user can choose to go back to the beginning and make more entries in their weekly schedule if desired.
